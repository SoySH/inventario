...
if ($_SERVER['REQUEST_METHOD']=='POST') {
    ...
    $sql="INSERT INTO productos (nombre, marca, modelo, numero_serie, cantidad, notas) 
          VALUES ('$nombre','$marca','$modelo','$numero_serie','$cantidad','$notas')";
    $conn->query($sql);
        ...
        <div class="card-body">
          <form method="POST">
            ...
            <div class="mb-3">
              ...
              <textarea name="notas" class="form-control" rows="3" placeholder="Información adicional sobre el producto..."></textarea>
            </div>
