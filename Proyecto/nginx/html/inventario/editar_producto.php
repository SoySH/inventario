          ...
          <form method="POST">
            ...
            <div class="row">
              <div class="col-md-6 mb-3">
                ...
                <input type="text" name="modelo" class="form-control" value="<?= htmlspecialchars($row['modelo']) ?>">
              </div>
              <div class="col-md-6 mb-3">
                <label class="form-label">Número de Serie</label>
                <input type="text" name="numero_serie" class="form-control" value="<?= htmlspecialchars($row['numero_serie']) ?>">
              </div>
            </div>
            <div class="mb-3">
